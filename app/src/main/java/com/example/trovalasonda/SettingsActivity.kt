...
import com.example.trovalasonda.databinding.ActivitySettingsBinding
...
class SettingsActivity : AppCompatActivity(), TextWatcher, FreqOffsetReceiver {
    ...
    override fun freqOffset(offset:Int) {
        ...
        binding.content.currentOffset.setText("($currentOffset)")
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.content.reset.setOnClickListener {
            with (binding.content) {
                ...
                m20bw.setSelection(7)
                m10bw.setSelection(7)
